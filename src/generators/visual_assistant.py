"""
Visual Assistant - Gerador Inteligente de Relatórios e Visualizações
Sistema avançado para análise automatizada de dados com geração de gráficos e insights
"""
...
from src.core.query import execute_query
